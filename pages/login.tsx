     ...
     className='relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14'>
      ...
      <div className='space-y-4'>
        <label className='inline-block w-full'>
           ...
           />
           {errors.email && (
           <p className='p-1 text-[13px] font-light text-orange-500'>This Field is required</p>
           )}
        </label>
        <label className='inline-block w-full'>
           <input 
           ...
           /> 
            {errors.password && (
           <p className='p-1 text-[13px] font-light text-orange-500'>Your password must contain 4 and 60 characters</p>
           )}
        </label>
      </div> 
